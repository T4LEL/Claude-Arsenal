...
description: Use this agent to get and keep users - SEO, content strategy, distribution channels, email lifecycle, ads basics, funnel and retention diagnosis. Give it the product, target user, and current numbers if any.
